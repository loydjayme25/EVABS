...
public class DBLeak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coords.execSQL("INSERT INTO CREDS VALUES('Dr.DroidMonk', '_andr0xSQLiteInvasi0n', 'ADMIN');");
        coords.execSQL("INSERT INTO CREDS VALUES('Ms NoDexa', '0xNotSecureSQLite_', 'STAFF');");
        coords.execSQL("INSERT INTO CREDS VALUES('Binda', 'SQLite_expl0it', 'USER');");
